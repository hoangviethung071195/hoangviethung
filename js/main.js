...
$(document).ready(function () {
    ...
    if ($('.skills').length > 0) {
        ...
        var el = new SimpleBar($('#resume .simplebar-content-wrapper')[0]).getScrollElement();
...
function sendCustomerInfo() {
    ...
    const fullName = document.getElementById('cf-name').value;
    ...
    fetch('http://localhost:5000/mail', {
        ...
        showAlertBox(r.status, 'Thank You! Your message has been sent.');
        console.log('r ', r);
    });
}